 ...
 * @author Short Corn
 */
public class LoadRewardAfterApplying extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            log("error at LoadRewardafterApplying: "+e.getMessage());
        }finally{
            request.getRequestDispatcher("reviewRank_User.jsp").forward(request, response);
