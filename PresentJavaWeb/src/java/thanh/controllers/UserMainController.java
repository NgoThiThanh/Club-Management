...
public class UserMainController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if(action.equalsIgnoreCase("regist")){
                url=PageLinkConstants.INSERTUSER;
            }else if(action.equalsIgnoreCase("loadUserData")){
                url=PageLinkConstants.LOADUSERDATA;
            
            }else if(action.equalsIgnoreCase("Search")){
                url=PageLinkConstants.SEARCHUSER;
            }
            else if(action.equalsIgnoreCase("delete")){
                url=PageLinkConstants.DELETEUSER;
            }
            else if(action.equalsIgnoreCase("edit")||action.equalsIgnoreCase("update")){
                url=PageLinkConstants.UPDATEUSER;
            }
            else{
