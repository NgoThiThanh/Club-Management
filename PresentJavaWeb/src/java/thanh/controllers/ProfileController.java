...
public class ProfileController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            model.findUserByPrimaryKey();
            request.setAttribute("DTO", model.getDto());
            if(model.getDto().getRole().equalsIgnoreCase("user")){
                url="profileUser.jsp";
            }else if(model.getDto().getRole().equalsIgnoreCase("admin")){
                url="profile.jsp";
            }
            System.out.println("user:"+username);
        } catch (Exception e) {
            log("ERROR at Profile Controller: "+e.getMessage());
        }finally{
