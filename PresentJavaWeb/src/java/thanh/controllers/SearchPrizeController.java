 ...
 * @author Short Corn
 */
public class SearchPrizeController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            System.out.println(bean.getMinPrice());
            System.out.println(bean.getMaxPrice());
            bean.findPrizeByPrice();
            request.setAttribute("INFO", bean.getListPrize());
            for (PrizeDTO object : bean.getListPrize()) {
                object.getPrizeName();
            }
        } catch (Exception e) {
            log("ERROR at SearchPrizeController: "+e.getMessage());
        }finally{
